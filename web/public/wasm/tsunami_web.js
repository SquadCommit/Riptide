...
function findWasmBinary() {
  return locateFile('tsunami_web.wasm');
}
...
${functionBody}
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(8, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createTsunamiModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createTsunamiModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createTsunamiModule);
